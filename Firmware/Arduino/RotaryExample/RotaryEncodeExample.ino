//THIS IS A BASIC EXAMPLE FOR CONTROL ALL FANS WITH A ROTARY ENCODER 
//IF YOU CHANGE THE VALUE BY ROTATING THE ENCODER THE RGB LED SHOWS THE STATUS AND FADES DOWN
//RED = 255 (FAN MAX), GREEN = 0 (FAN MIN / FAN POWER OFF), BLUE = PWM SIGNAL BETWEEN 1 - 254
