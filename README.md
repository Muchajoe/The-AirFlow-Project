...
* **Industrial Protection (eFuse):** A dedicated Texas Instruments TPS1H100-Q1 chip protects your fans, the board traces, and your power supply. It features a strict hardware-level cutoff at exactly **2.5 Amps** to prevent any damage from shorted fan cables or blocked motors.
...
### Troubleshooting
Is something not working? Take a look here:<br>
👉 [Troubleshooting](Troubleshooting)
You are searching for a replacement part:<br>
👉 [BOM](/Hardware/README.md)
Some isssues are known and we will work on that for future revisions:<br>
👉 [Known issues](https://github.com/Muchajoe/The-AirFlow-Project/issues/2)
