...
[![Buy on Tindie](https://img.shields.io/badge/Buy_on-Tindie-blueviolet.svg)](https://www.tindie.com/products/the-omega-projects/the-airflow-project-esp32-pwm-fan-controller/)
...
<img src="/Hardware/Photo_1.png" alt="Photo 1" width="800"/>
...
* **Overbuilt Power Delivery:** To ensure absolute thermal stability, the main 12V power traces are routed at a massive 1.9 mm width. Even running four [heavy-duty (noctua.at)](https://www.noctua.at/en/products/nf-f12-industrialppc-3000-pwm/specifications) fans at 100% capacity 24/7, the board remains completely cold, for a maximum lifespan of components.
...
<img src="/Hardware/Photo_2.png" alt="Photo 2" width="800"/>
...
* **Industrial Protection (eFuse):** A dedicated Texas Instruments TPS1H100-Q1 chip protects your fans, the board traces, and your power supply. It features a strict hardware-level cutoff at **2.5 Amps** to prevent any damage from shorted fan cables or blocked motors.
...
* **ESD & Transient Protection (Only Revision 2.1 or newer):** A combined defense using an SMF15A TVS diode and a BZT52C15 Zener diode aggressively clamps down sudden voltage spikes from the power supply or static discharge. This dual-stage approach fully protects both the power-entry circuitry and the sensitive core logic.
...
<img src="/Hardware/Photo_4.png" alt="Photo 4" width="800"/>
...
_INFO: This configuration switches the Fan power automatically. If one or more fans are set to more than 0% PWM it switches the Fan power rail on_<br>
...
It may be possible to use a ESP32C6 XIAO. You must mount it upside down (5v, GND, 3.3V Pins must match the board labeled 5v, GND, 3.3v). And you dont have the full features (because of the missing pins obviously)
